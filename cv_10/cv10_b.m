...
subplot(5,1,4);
plot(f,abs(X3)/N);
title('Spektrum signálu x filtrovaného diferenciátorem');
xlabel('f');
ylabel('|X(f)|');
...
% Pøehrání pùvodního signálu a signálù po filtraci
sound(x,Fs);
pause(1)
sound(x1,Fs);
pause(1)
